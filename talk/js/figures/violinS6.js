...
(function () {
  ...
  MDC.figures['violinS6'] = function (mount, opts) {
    ...
    bracket(brG, 0, 2, topOuterY, +1, 'r = 0.668, 99.5% CI [0.460; 0.800], p < 0.005', true);
    bracket(brG, 1, 2, topInnerY, +1, 'r = 0.649, 99.5% CI [0.430; 0.790], p < 0.005', true);
    ...
    bracket(brG, 1, 3, botInnerY, -1, 'r = 0.671, 99.5% CI [0.500; 0.800], p < 0.005', false);
    bracket(brG, 0, 3, botOuterY, -1, 'r = 0.672, 99.5% CI [0.440; 0.820], p < 0.005', false);
