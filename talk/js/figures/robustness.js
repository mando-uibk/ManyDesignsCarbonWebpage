...
(function () {
  ...
  MDC.figures['robustness'] = function (mount, opts) {
    ...
    function buildS7(host, P) {
      ...
      fade(MDC.el('text', { x: px1 - 6, y: 192, 'text-anchor': 'end', 'font-size': 11.5, 'font-style': 'italic', fill: P.muted, text: 'Median z = 2.637,  p (one-tailed) = 0.0042' }, s), 34);
      panel(250, 380, [0.116, 0.131], [0.116, 0.120, 0.124, 0.128], 'tau', 'Heterogeneity τ', true);
