...
(function () {
  ...
  MDC.figures['fig3'] = function (mount, opts) {
    ...
    (function buildConnectors() {
      ...
      // observed-vs-stated correlation annotation (paper reports Pearson r = 0.175, 99.5% CI [-0.209, 0.512]).
      ...
      var annStat = MDC.el('text', {
        ...
        'font-size': 16, 'font-weight': 800, 'font-style': 'italic', fill: P.greenDeep, text: 'r = 0.175'
      }, gConn);
